        ...
        if inspect_permission:
            ...
            if compare_result:
                ...
                if get_message == 'True' and get_message_2 == '4':
                    ...
                    ##경진
                    history_info = InspectAdapter_1st().get_history_info(task_num)
                    self.res_dic['history_info'] = history_info

                    self.res_dic['task_info'] = task_info_list #통일
...
def task_inspect(request,task_num, work_type):
    TaskInfoAdapter().task_inspect(request);
