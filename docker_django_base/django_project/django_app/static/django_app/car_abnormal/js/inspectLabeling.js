...
class ImageLabeler {
    ...
    addLabelform(num) {
        ...
        str += "<select name='label-box-occupantId' id='label-box-occupantId" + num + "' onchange='labeler.changeDataKinds(" + num + ")' disabled>";
        ...
        str += "</select>";
        str += "<select name='label-box-data' id='label-box-data" + num + "' onchange='labeler.callFunction(" + num + ")' disabled>";
        str += "<option value=''>선택</option>";
        for(var key in dataMap){
            str += "<option value='" + key + "'>" + dataMap[key] + "</option>";
        }
        str += "</select>";
        str += "<select name='label-box-emotion' id='label-box-emotion" + num + "' onchange='labeler.saveLabeledData(" + num + ")' disabled>";
        str += "<option value=''>선택</option>";
        for(var key in emotionMap){
            str += "<option value='" + key + "'>" + emotionMap[key] + "</option>";
        }
        str += "</select>";
        str += "<select name='label-box-action' id='label-box-action" + num + "' onchange='labeler.saveLabeledData(" + num + ")' disabled>";
        str += "<option value=''>선택</option>";
