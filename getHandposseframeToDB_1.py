...
for task_row in task_list:
    try:
        ...
        '''
        # For webcam input:
        #video_file = task_list["video_path"] #운용
        video_file = "./mp4/p01_1h_if_f40_20210814_144037(3)_Y.mp4" #테스트
        ...
        with mp_hands.Hands(min_detection_confidence=0.5, min_tracking_confidence=0.5) as hands:
            ...
            while cap.isOpened():
                ...
                # 3.분할된 위치에서 핸드포즈가 있는 프레임위치를 찾는다.
                if  run_frame >= ( frame_start + (total_frame_mid * frameCnt ) ): #분활된 프레임위치
                ...
                if run_frame >= frame_end or frameCnt>=5:
                    break
